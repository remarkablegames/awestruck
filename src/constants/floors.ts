...
export const FLOOR_DEFINITIONS: FloorDefinition[] = [
  ...
  // floor 7
  {
    ...
    enemyIntents: [
      ...
      {
        block: 11,
        description: 'Guard for 11 block.',
        id: 'guard',
        label: 'DEFEND',
      },
      {
        attack: 12,
        block: 10,
        description: 'Advance with 12 damage and 10 block.',
        id: 'advance',
        label: 'PRESSURE',
      },
      {
        attack: 18,
        description: 'Discharge a corrosive volley for 18 damage.',
        id: 'discharge',
        label: 'ATTACK',
      },
    ],
  ...
  // floor 8
  {
    ...
    enemyIntents: [
      ...
      {
        block: 20,
        description: 'Fortify and gain 20 block.',
        id: 'fortify',
        label: 'DEFEND',
      },
      {
        attack: 11,
        block: 10,
        description: 'Advance with 11 damage and 10 block.',
        id: 'advance',
        label: 'PRESSURE',
      },
      {
        attack: 20,
        description: 'Tear for 20 damage.',
        id: 'tear',
        label: 'ATTACK',
      },
      {
        attack: 13,
        block: 11,
        description: 'Relentlessly strike for 13 damage and 11 block.',
        id: 'relentless',
        label: 'ASSAULT',
      },
    ],
